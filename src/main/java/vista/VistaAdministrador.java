...
public class VistaAdministrador extends javax.swing.JFrame {
    ...
    private void btnGestionarUsuariosActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGestionarUsuariosActionPerformed
        try {
        // 1. Crear la nueva instancia de la vista, pasando el control y la vista actual
        VistaGestionarUsuarios panelUsuarios = new VistaGestionarUsuarios(this.control, this); 
    ...
    private void btnGestionarReportesActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnGestionarReportesActionPerformed
       try {
        // 1. Crear la nueva instancia, pasando el control y la vista actual ('this')
        VistaGestionarReportes panelReportes = new VistaGestionarReportes(this.control, this);
        ...
        e.printStackTrace();
        JOptionPane.showMessageDialog(this,
            "Error al abrir la gestión de reportes: " + e.getMessage(),
            "Error de Navegación",
            JOptionPane.ERROR_MESSAGE);
    }
